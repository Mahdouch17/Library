...
app.get("/", async (req, res) => {
  ...
  if (edition != undefined && edition != "Choisissez l'édition") {
    filter.push("editionId = ?");
    params.push(edition);
  }
  if (category != undefined && category != "Choisissez la catégorie") {
  ...
  if (
    ...
    (edition == undefined || edition == "Choisissez l'édition") &&
    (category == undefined || category == "Choisissez la catégorie")
  ) {
    filter.push("1=1");
    sql1 += filter.join(" ");
